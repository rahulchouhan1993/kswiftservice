        ...
        <>
            <button
                ...
                className={
                    btnclasses
                        ? btnclasses
                        : "w-8 h-8 flex items-center justify-center rounded-full hover:bg-red-600 dark:hover:bg-red/10 text-gray-900 dark:text-gray-200 hover:text-white transition duration-150"
                }
            ...
            <Modal show={open} maxWidth="sm" zindex={zindex}>
                {processing ? (<>
                    ...
                    <div className="btn p-4 md:p-5 flex items-center flex-col dark:bg-[#0a0e25]">
                        <DotLottieReact
                        ...
                        <div>
                            ...
                            <button
                                ...
                                type="button"
                                className="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-tks-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-[#131836] dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                            >
                                No, cancel
                            </button>
                        </div>
