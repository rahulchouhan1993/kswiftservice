...
export default function CustomerTermsConditions() {
    ...
    return (
        ...
        <Layout>
                    ...
                    <Head title={`${t('legal_pages.customer_terms.title')} - KSwift Services`} />
                            ...
                            <div className="  relative overflow-hidden">
                                ...
                                <div className="relative z-10 max-w-4xl mx-auto px-6 py-16">
                                        ...
                                        {sections.map((section) => (
                                            <section key={section.key}>
                                                <h2 className="text-xl font-bold mb-4 uppercase tracking-wide">
                                                    {t(`legal_pages.customer_terms.sections.${section.key}.title`)}
                                                </h2>
                                                {section.type === 'text' ? (
                                                    <p className="text-gray-200">
                                                        {t(`legal_pages.customer_terms.sections.${section.key}.content`)}
                                                    </p>
                                                ) : (
                                                    <div className="text-gray-200 space-y-2">
                                                        {(t(`legal_pages.customer_terms.sections.${section.key}.items`, { returnObjects: true }) || []).map((item, index) => (
                                                            <p key={index}>{item}</p>
                                                        ))}
                                                    </div>
                                                )}
                                    ...
                                    <footer className="mt-16 text-center text-sm text-gray-400">
                                        {t('legal_pages.customer_terms.footer', '© 2025 KOUSTUBHA FAST SERVICES. All rights reserved.')}
                                    </footer>
