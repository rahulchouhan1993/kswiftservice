...
export default function List({ list, search }) {
        ...
        if (search !== sval) {
            ...
            if (!sval || sval.length > 0) {
                timerRef.current = setTimeout(() => {
                    router.visit(route('superadmin.activity_log.list', {
                        search: sval,
                    }), {
                        only: ['list', 'search'],
                        preserveScroll: true,
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Manage Activity Logs List " />
                        ...
                        <table className=" min-w-full bg-gray-100 text-black  dark:bg-[#0a0e25] dark:text-white">
                            <thead className="border-b border-gray-300 dark:border-blue-900 ">
                                <tr>
                                    ...
                                    <th className="p-2 text-start whitespace-nowrap">Message</th>
                                ...
                                {list.data.length === 0 ? (
                                    ...
                                    list.data.map((l, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-2 text-sm">{capitalizeWords(l?.message)}</td>
