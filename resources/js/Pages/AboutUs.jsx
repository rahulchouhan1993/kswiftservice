        ...
        <Layout>
            ...
            <div className='container mx-auto'> 
                    ...
                    <div className='relative z-[10] pt-[200px]'>
                        <h1 className='text-bold text-white mx-auto text-[50px] text-center max-w-[700px] leading-[43px]'>Built to Fix How India Maintains Its Vehicles</h1>
                        <p className='max-w-[1000px] mx-auto text-gray-300 text-center mt-2'>This platform was created after recognizing a common problem: people don’t trust how their vehicles are serviced, and Partners  don’t have the tools or structure to deliver consistent service. Both sides operate manually, leading to confusion, delays, and disputes.</p>
                        <p className='max-w-[1000px] mx-auto text-gray-300 text-center mt-2'>We designed a system that brings clarity and structure to a broken process.</p>
                        <div className='rounded-[30px] mt-[50px] overflow-hidden max-w-[90%] mx-auto'>
                    ...
                    <AboutFeatures />
                     ...
                     <div className='container mx-auto'>
                        <div className="mt-[60px] rounded-[25px] !p-[1px] bg-gradient-to-r from-gray-600 to-gray-800">
                            <div className="bg-black rounded-[25px] relative z-10 max-w-7xl mx-auto px-6 py-10 !pb-2 text-center overflow-hidden">
                                ...
                                <div className='live-bar bg-black px-3 py-8 mb-2'>
                                    <ul className='flex justify-center gap-6'>
                                    <li className='text-white uppercase border-r border-gray-600 ps-[40px] pe-[40px] ' >
