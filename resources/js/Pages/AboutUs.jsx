        ...
        <Layout>
            ...
            <div className=''> 
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mt-12 sm:mt-16 md:mt-20'>
                        <div className=' relative p-[1px] rounded-xl sm:rounded-2xl overflow-hidden bg-gradient-to-r from-gray-600 to-gray-800'>
                            <div className="bg-dark rounded-xl sm:rounded-2xl overflow-hidden p-5 sm:p-6 md:p-8 h-full">
                                <div className="mb-4 sm:mb-6">
                                    <img 
                                        src={mission} 
                                        className='fading h-12 w-12 sm:h-14 sm:w-14 object-contain' 
                                        alt="Mission icon"
                                        loading="lazy"
                                    />
                                </div>
                        ...
                        <div className=' relative p-[1px] rounded-xl sm:rounded-2xl   bg-gradient-to-r from-gray-600 to-gray-800'>
                            <div className="bg-dark rounded-xl sm:rounded-2xl  n p-5 sm:p-6 md:p-8 h-full">
                                <div className="mb-4 sm:mb-6">
                                    <img 
                                        src={vision} 
                                        className='fading h-12 w-12 sm:h-14 sm:w-14 object-contain' 
                     ...
                     <div className=''>
                        <div className='mt-12 sm:mt-16 md:mt-20'>
                            <div className="rounded-[25px] p-[1px] bg-gradient-to-r from-gray-600 to-gray-800">
                                <div className="bg-black rounded-[25px] relative z-10 w-full mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-16 md:py-20 text-center">
