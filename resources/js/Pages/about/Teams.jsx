        ...
        <div className=' mx-auto'>
            <div className='py-20'>
                <div className="text-center mb-8">
                    <h2 className="fading text-white text-3xl lg:text-4xl font-bold mb-2">{t('about.teams.title', 'The Team Behind the Platform')}</h2>
                    <p className='fading text-gray-500 mb-8 max-w-[800px] mx-auto'>{t('about.teams.description', 'A cross-functional team of engineers, designers, and automotive professionals focused on building a predictable, technology-driven service ecosystem.')}</p>
                </div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4'>
                    ...
                    <div className='text-center mb-3 w-full sm:max-w-[400px] lg:max-w-[auto] '>
                        ...
                        <p className='text-main uppercase fading text-bold text-sm'>{t('about.teams.roles.ceo_founder', 'CEO & Founder')}</p>
                    </div>
                    <div className='text-center mb-3 w-full sm:max-w-[400px] lg:max-w-[auto] '>
