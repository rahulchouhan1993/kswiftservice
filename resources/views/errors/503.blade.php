...
<body class="bg-gradient-to-br from-gray-100 to-gray-300 min-h-screen flex items-center justify-center px-4">
    ...
    <div class="rounded-2xl shadow-2xl p-10 max-w-lg w-full text-center">
        ...
        <div class="flex items-center justify-center space-x-4 mt-4">
            <svg class="w-6 h-6 text-yellow-500 animate-spin" fill="none" stroke="currentColor" stroke-width="2"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="M12 4V2m0 20v-2m8.485-8.485l1.414-1.414M4.222 19.778l1.414-1.414M20 12h2M2 12h2m15.364 6.364l1.414 1.414M4.222 4.222l1.414 1.414" />
            </svg>
